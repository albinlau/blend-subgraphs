...
import { ProtocolOracle } from '../../generated/templates/ChainlinkAggregator/ProtocolOracle';
...
export function updateAssetPriceFromProtocolOracle(event: ethereum.Event): void {
